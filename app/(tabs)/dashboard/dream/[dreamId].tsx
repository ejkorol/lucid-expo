...
const Dream = () => {
  return (
    <SafeAreaView className="bg-[#fff] h-full">
      <ScrollView className="px-6 mb-8">
        <View className="mt-4">
          <Image
        ...
        <View className="mt-6">
          <Label styles="mb-2">Your dream</Label>
        ...
        <View className="mt-4">
          <Label styles="mb-2">Analysis</Label>
          <Text className="font-inter text-sm tracking-tight text-[#212121]">
            I find myself wandering through a vast, mist-covered forest
            illuminated by the soft glow of moonlight. As I traverse the winding
            pathways I am for some reason trying to capture the running horse
            that Jane is riding. She is a mongolian queen?
